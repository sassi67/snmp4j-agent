...
public class SnmpAgentVacmGroupTest {
    ...
    public void testDefaultValues() {
        ...
        assertEquals("Wrong security model", SecurityModel.SECURITY_MODEL_SNMPv2c, vg.getSecurityModel());
        assertEquals("Wrong security name", new OctetString("cpublic"), vg.getSecurityName());
        assertEquals("Wrong group name", new OctetString("v1v2group"), vg.getGroupName());
        assertEquals("Wrong storage type", StorageType.nonVolatile, vg.getStorageType());
    }
    ...
    public void testAssertOnWrongValues() {
        ...
        Exception exceptionOnWrongSecurityModelLow = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            vg.setSecurityModel(wrongSecurityModelLow);
        });
        ...
        Exception exceptionOnWrongSecurityModelHigh = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            vg.setSecurityModel(wrongSecurityModelHigh);
        });
        ...
        Exception exceptionOnWrongStorageTypeLow = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            vg.setStorageType(wrongStorageTypeLow);
        });
        ...
        Exception exceptionOnWrongStorageType = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            vg.setStorageType(wrongStorageTypeHigh);
        });
